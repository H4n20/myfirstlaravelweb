        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-2">
                <select name="user_catalogue_id" class="form-control" onchange="this.form.submit()">
                    <option value="0" {{ request('user_catalogue_id') == 0 ? 'selected' : '' }}>Select group</option>
                    <option value="1" {{ request('user_catalogue_id') == 1 ? 'selected' : '' }}>Administrators</option>
                    <option value="2" {{ request('user_catalogue_id') == 2 ? 'selected' : '' }}>Users</option>
                </select>
            </div>
            <div class="col-md-4">
